...
const ContentHeader = ({
  ...
  return (
    <div className="text-gray-800 relative">
      <div
        ref={heroRef}
        className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden"
      >
        <div className="relative min-h-screen w-full flex flex-col overflow-hidden">
          ...
          {/* Content */}
          <div className="relative z-20 flex-1 flex items-center px-4 sm:px-8 lg:px-16 -mt-10">
              ...
              >
                ...
                {description && (
                  <motion.p
                    ...
                    md:text-[clamp(1rem,1.6vw,1.2rem)]
                    lg:text-[clamp(1.1rem,1.7vw,1.3rem)]
                    xl:text-[clamp(1.2rem,1.8vw,1.4rem)]
