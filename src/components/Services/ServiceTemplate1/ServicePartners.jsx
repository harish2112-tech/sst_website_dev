          ...
          {items.map((partner, idx) => {
            ...
            return (
              <motion.div
                ...
                className="h-28 flex items-center justify-center bg-white border border-slate-200/60 hover:border-blue-500/20 rounded-xl p-6 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/5 hover:bg-white group cursor-pointer shadow-sm"
              >
                {partner.link ? (
