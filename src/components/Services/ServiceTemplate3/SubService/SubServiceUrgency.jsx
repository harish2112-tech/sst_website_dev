      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            {/* Stat Callout */}
            {metricHighlight && (
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-6 md:p-8 flex items-center gap-6 shadow-sm">
              ...
              return (
                <div
                  ...
                  className={`border rounded-2xl transition-all duration-300 ${
                    isOpen ? "border-blue-500 bg-slate-50/50 shadow-md" : "border-slate-200 hover:border-slate-300"
                  }`}
                >
                  <button
                  ...
                  >
                    ...
                    <span className="ml-4 flex-shrink-0 w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-blue-50 group-hover:text-blue-600 transition-colors">
