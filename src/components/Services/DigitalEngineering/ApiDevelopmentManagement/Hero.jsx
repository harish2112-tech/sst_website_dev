  ...
  return (
    <section className="relative bg-white py-16 sm:py-24 px-4 sm:px-8 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        >
          High-Performance API Development &amp; Management
        </motion.h1>
        ...
        >
          Design lightweight REST, GraphQL, and gRPC endpoints protected by robust payload gateways. SST develops API architectures optimized for high-volume database queries, complete with authentication controls, rate limits, and real-time metrics tracking.
        </motion.p>
        ...
        >
          Scale Endpoints. Manage Traffic. Secure Backends.
        </motion.p>
      </div>
    </section>
  );
