...
const GRID_ID = "connected-exchange-insight";

const INSIGHT = {
  eyebrow: "Research Report",
  title: "Scaling Real-Time Message Exchange Architectures",
  description:
    "Evaluate your queue capacities, isolate transaction delivery lags, and configure auto-scaling message brokers safely.",
  content: [
    "Enterprises that deploy high-volume database pipelines without intermediate broker queues risk severe data losses during server failures. This report outlines what separates resilient event-driven systems from fragile database links.",
    "We detail how schema registries, dead-letter storage lanes, and Grafana monitoring tools enable companies to build scalable data exchanges without adding operational risk.",
  ],
  highlights: [
    "A developer playbook for configuring Apache Kafka clusters",
    "How to manage schema migrations across active broker topics",
    "A reference template for tuning dead-letter queue retries and alert limits",
  ],
};
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-12 sm:gap-14">
        ...
        >
          ...
          <p className="text-lg sm:text-xl font-light text-[#515151] max-w-2xl mx-auto">
            Evaluate your messaging routes, discover queue monitoring dashboards, and scale pipelines.
          </p>
        </motion.div>
        ...
        >
          <Image
            src={InsightBg}
            alt="Connected Data Exchange Insights"
            fill
