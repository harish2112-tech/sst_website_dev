...
const GRID_ID = "enterprise-integration-insight";

const INSIGHT = {
  eyebrow: "Research Report",
  title: "Unified Architectures for Enterprise Integration",
  description:
    "Evaluate your current CRM and ERP connections, identify transaction anomalies, and deploy webhook-driven real-time pipelines.",
  content: [
    "Enterprises operating across siloed applications lose thousands of productive hours due to manual entry errors. This report looks at what separates organizations that build automated system-to-system integrations from those still copy-pasting customer profiles.",
    "We detail how modern OAuth controls, caching pools, and event trigger workers enable companies to establish stable data flows without breaking active legacy operations.",
  ],
  highlights: [
    "A developer playbook for secure Salesforce and SAP ERP integration",
    "How to manage API payload failures and configure automatic retry schedules",
    "A reference template for provisioning unified OAuth keys across environments",
  ],
};
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-12 sm:gap-14">
        ...
        >
          ...
          <p className="text-lg sm:text-xl font-light text-[#515151] max-w-2xl mx-auto">
            Evaluate your enterprise connection routes, discover webhook architectures, and scale automation.
          </p>
        </motion.div>
        ...
        >
          <Image
            src={InsightBg}
            alt="Enterprise Integration Insights"
            fill
