  ...
  return (
    <>
      ...
      <ContentCardSection
        ...
        description="SAP Customer Experience
 is a deployment option of SAP's next-generation enterprise resource planning (ERP) suite. Unlock the full potential of your enterprise with SAP S/4HANA On-Premises, the leading-edge ERP solution designed to elevate your business operations to new heights. Seamlessly integrating cutting-edge technology with unparalleled functionality,"
        cards={[
          {
...
export default SAPCustomerExperience;
