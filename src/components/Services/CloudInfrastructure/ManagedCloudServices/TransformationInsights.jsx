...
import InsightBg from "@/assets/Service/Cloud & Infrastructure/Managed Cloud Services/insights-research-report.jpg";

const GRID_ID = "managed-cloud-services-insight";

const INSIGHT = {
  eyebrow: "Research Report",
  title: "Rethinking Cloud Operations for an Always-On World",
  description:
    "Evaluate your current environment, identify optimization opportunities, and create a roadmap aligned with your business objectives.",
  content: [
    "Managed cloud services fail quietly, not loudly. Environments don't crash overnight — they drift: patches fall behind, costs creep up, and monitoring gaps widen until an incident forces the issue. This report looks at what separates teams that stay ahead of drift from those that only react to it.",
    "We break down the operating model leading enterprises use to keep cloud environments secure, cost-efficient, and available around the clock — without needing to grow their internal team headcount to match.",
  ],
  highlights: [
    "A framework for scoring operational maturity across monitoring, security, and cost",
    "How to build a proactive incident-response cadence instead of a reactive one",
    "A checklist for choosing between in-house, managed, and hybrid operating models",
  ],
};
    ...
    <section className="py-16 sm:py-20 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto flex flex-col gap-10 sm:gap-14">
        ...
        <motion.button
          ...
          whileHover={{ y: -4 }}
          className="relative w-full rounded-[20px] overflow-hidden min-h-[280px] sm:min-h-[360px] shadow-[5px_5px_11.6px_0px_rgba(217,217,217,0.18)] text-left cursor-pointer"
        >
          <Image
            src={InsightBg}
