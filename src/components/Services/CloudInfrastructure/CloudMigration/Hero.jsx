  ...
  return (
    <section className="relative bg-white py-16 sm:py-24 px-4 sm:px-8 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        >
          Cloud migration transforms ideas into scalable digital solutions. SST helps
          organizations plan, migrate, and optimize workloads that accelerate innovation, improve
        ...
        >
          Migrate Faster. Operate Smarter. Scale Confidently.
        </motion.p>
      </div>
    </section>
  );
