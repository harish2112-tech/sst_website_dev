...
import CtaBg from "@/assets/Service/Cloud & Infrastructure/Infrastructure Modernization/b37fa11a90d7ce5d12475b7f98834669659a5ff0.png";
      ...
      <div className="relative z-10 flex flex-col items-center text-center gap-8 sm:gap-10 py-16 sm:py-24 px-4 sm:px-8">
        ...
        >
          ...
          <p className="font-light text-white text-[15px] sm:text-[18px] lg:text-[22px] max-w-[560px] mx-auto">
            Let&apos;s build a modernization plan that drives growth and efficiency for your
            business
          </p>
        </motion.div>
