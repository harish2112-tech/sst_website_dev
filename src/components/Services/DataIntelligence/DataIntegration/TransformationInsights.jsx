...
import InsightBg from "@/assets/Service/Data&Intelligence/Data Integration/Section Text.jpg";

const GRID_ID = "data-integration-insight";

const INSIGHT = {
  eyebrow: "Research Report",
  title: "Breaking Down Data Silos in the Modern Enterprise",
  description:
    "See how leading enterprises map their integration landscape, prioritize connections by business impact, and modernize without disrupting daily operations.",
  content: [
    "Most enterprises don't lack data — they lack a way to move it reliably between the systems that depend on it. This report examines why point-to-point integrations break down at scale, and what separates organizations that treat integration as durable infrastructure from those still patching brittle connections one system at a time.",
    "We break down the framework leading enterprises use to map their integration landscape, prioritize which connections matter most to the business, and modernize without disrupting the operations that depend on them every day.",
  ],
  highlights: [
    "A framework for mapping your current integration landscape",
    "How to prioritize integration investments by business impact",
    "A phased roadmap for moving from point-to-point to event-driven integration",
  ],
};
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-12 sm:gap-14">
        ...
        >
          ...
          <p className="text-lg sm:text-xl font-light text-[#515151] max-w-2xl mx-auto">
            See how leading enterprises map their integration landscape and modernize without
