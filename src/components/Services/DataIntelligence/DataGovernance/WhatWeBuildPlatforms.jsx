...
const PIPELINES = [
  { title: "Metadata Registries", desc: "Enterprise catalogs that automatically document data definitions and schema variations." },
  { title: "Lineage Diagrams", desc: "Interactive mapping pathways showing data hops from operational systems to business portals." },
  { title: "Access Policies", desc: "Granular authorization rules that dynamically filter database rows based on user roles." },
];

const PLATFORMS = [
  { title: "Compliance Frameworks", desc: "Implement robust security policies tailored for CCPA and GDPR standard compliance audits.", image: realTimeImg },
  { title: "Quality Profiling Sweeps", desc: "Automated test beds checking table columns for duplicates or anomalous metrics.", image: cloudImg },
  { title: "Audit & Access Portals", desc: "Central portals detailing data queries, access logs, and lineage alterations.", image: analyticsImg },
];
