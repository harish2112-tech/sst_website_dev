  ...
  return (
    <section className="relative bg-white py-16 sm:py-24 px-4 sm:px-8 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        >
          Data is one of your organization&apos;s most valuable assets—but only when it&apos;s
          trusted, connected, and actionable. SST helps businesses build modern data foundations
          that enable smarter decisions, operational efficiency, and continuous innovation
