...
const GRID_ID = "advanced-analytics-insight";

const INSIGHT = {
  eyebrow: "Research Report",
  title: "Predictive Intelligence & Time-Series Analytics",
  description:
    "Evaluate your analytics tools, identify pipeline gaps, and deploy machine learning models that forecast demand variations.",
  content: [
    "Enterprises that rely solely on historical logs miss out on immediate market signals. This report looks at what separates organizations that build real-time prediction pipelines from those still running yesterday's batches.",
    "We outline the algorithms and tools teams need to integrate forecasting sandboxes and dynamic dashboard structures into their active cloud lakehouses.",
  ],
  highlights: [
    "A self-assessment checklist for analytics platform maturity",
    "How to manage features and model deployments on Snowflake and Databricks",
    "A template for calculating statistical significance in customer segment splits",
  ],
};
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-12 sm:gap-14">
        ...
        >
          ...
          <p className="text-lg sm:text-xl font-light text-[#515151] max-w-2xl mx-auto">
            Evaluate your forecasting models, discover streaming algorithms, and scale intelligence.
          </p>
        </motion.div>
