    ...
    return (
        <section className="relative z-10 w-full pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 bg-white">
            ...
            <motion.div
                ...
                className="relative z-20 bg-white max-w-[1300px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 -mb-24 sm:-mb-30 lg:-mb-[180px]"
            >
                {INSIGHTS.map((item, index) => (
                    <motion.div
                        key={index}
                        variants={itemVariants}
                        className="flex flex-col gap-5 px-6 py-4 border-b lg:border-b-0 lg:border-r border-[#d9d9d9] last:border-0"
                    >
