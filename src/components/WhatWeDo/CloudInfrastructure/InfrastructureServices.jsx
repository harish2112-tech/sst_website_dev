...
export default function InfrastructureServices() {
    return (
        <section className="w-full py-10 sm:py-16 px-6 sm:px-[50px] flex justify-center">
            <div className="w-full max-w-[1150px] flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-[80px]">
                <motion.div
                    initial={{ opacity: 0, x: -20 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true, amount: 0.3 }}
                    transition={{ duration: 0.6, ease: "easeOut" }}
                    className="flex flex-col items-center lg:items-start gap-4 text-center lg:text-left w-full lg:w-[647px]"
                >
                ...
                <motion.div
                    ...
                    viewport={{ once: true, amount: 0.3 }}
                    transition={{ duration: 0.6, ease: "easeOut" }}
                    className="relative w-full max-w-[503px] h-[240px] sm:h-[340px] lg:h-[412px] shrink-0 overflow-hidden"
                >
