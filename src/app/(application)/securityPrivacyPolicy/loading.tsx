...
export default function SecurityPrivacyPolicyLoading() {
  return (
    <div className="relative w-full bg-white overflow-hidden min-h-screen">
      ...
      {/* Security Privacy Policy Text skeleton */}
      <main className="max-w-4xl mx-auto px-6 py-16 flex flex-col gap-4">
